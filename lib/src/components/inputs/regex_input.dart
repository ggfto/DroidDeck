...
class RegexInput extends StatefulWidget {
  ...
  final TextStyle?
      inputStyle; // Nova propriedade para escolher o estilo do campo de entrada
  ...
  const RegexInput({
    ...
    this.inputStyle, // Pode ser nulo para usar o estilo padrão do TextField
  });

  @override
  _RegexInputState createState() => _RegexInputState();
}
...
class _RegexInputState extends State<RegexInput> {
  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      style: widget.inputStyle, // Define o estilo do campo de entrada
